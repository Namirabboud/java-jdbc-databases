...
public class InsertOrderDao {
                    ...
                    if(!result.next()){
                        ...
                        for (OrderDetailDto orderDetailDto : orderDto.getOrderDetail()) {
                            ...
                            try (PreparedStatement detailsPS =
                                ...
                                int detailsResult = detailsPS.executeUpdate();
    ...
    private PreparedStatement createOrderPreparedStatement(Connection con, OrderDto orderDto) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement(this.sqlOrder, Statement.RETURN_GENERATED_KEYS);
        preparedStatement.setDouble(1, orderDto.getCustomerId());
    ...
    private PreparedStatement createOrderDetailPreparedStatement(Connection con, OrderDetailDto orderDetailDto) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement(this.sqlOrderDetail);
        preparedStatement.setDouble(1, orderDetailDto.getOrderId());
        preparedStatement.setDouble(2, orderDetailDto.getProductId());
